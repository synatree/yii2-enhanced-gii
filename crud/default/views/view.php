...
?>
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            ...
            'heading' => '<span class="fas fa-book"></span> ' . Html::encode(<?= $generator->generateString( $generator->pluralize ? Inflector::pluralize(Inflector::camel2words($rel[1])) : Inflector::camel2words($rel[1])) ?>),
        ],
<?php if(!$generator->pdf): ?>
        'export' => false,
<?php endif; ?>
